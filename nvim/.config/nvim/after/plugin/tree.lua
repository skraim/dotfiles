...
local function open_in_files()
    local file_path = get_current_node_path()
    vim.fn.system(string.format('nautilus "%s"', file_path))
end
...
local function my_on_attach(bufnr)
    ...
    local function toggleCurrentNodeBookmark()
        local file_path = get_current_node_path()
        api.marks.toggle(file_path)
    end
    ...
    vim.keymap.set("n", "of", open_in_files, opts("Open In Files"))
